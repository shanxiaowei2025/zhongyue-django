...
class Customer(models.Model):
    ...
    has_online_banking = models.BooleanField(blank=True, null=True, verbose_name="是否办理网银盾", help_text="企业是否办理了网上银行", db_comment="企业是否办理了网上银行")
    is_online_banking_custodian = models.BooleanField(blank=True, null=True, verbose_name="是否网银盾托管", help_text="企业的网银盾是否由我方托管", db_comment="企业的网银盾是否由我方托管")
